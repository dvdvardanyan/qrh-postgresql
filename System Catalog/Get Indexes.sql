...
left outer join pg_namespace as schm on tbl.relnamespace = schm.oid
left outer join pg_index as inx_dtl on tbl.oid = inx_dtl.indrelid
left outer join pg_class as inx on inx_dtl.indexrelid = inx.oid
